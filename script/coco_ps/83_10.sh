...
base=results/ade_ps
step_args="CONT.BASE_CLS 83 CONT.INC_CLS 10 CONT.MODE overlap SEED 42"
task=mya-pan_83-10-ov
...
inc_args="CONT.TASK 1 SOLVER.MAX_ITER ${iter} SOLVER.BASE_LR ${base_lr} TEST.EVAL_PERIOD 4000 SOLVER.CHECKPOINT_PERIOD 500000 CONT.WEIGHTS results/ade_ps/coc-pan_83-10-ov-c/231211_240K_R50_Query(100)_NPT(0)_DeepCLS(True)_SoftCLS(False)_SoftMask(False)_LR(0.0001)_MW(5.0)_CW(2.0)/step0/model_final.pth"
...
inc_args="CONT.TASK 5 CONT.WEIGHTS results/coco_ps_83_10_final.pth"
