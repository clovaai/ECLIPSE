...
base=results/ade_ps
step_args="CONT.BASE_CLS 50 CONT.INC_CLS 20 CONT.MODE overlap SEED 42"
task=mya-pan_50-20-ov
...
inc_args="CONT.TASK 5 CONT.WEIGHTS results/ade_ps_50_20_final.pth"
